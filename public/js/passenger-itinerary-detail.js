...
function initMap (data) {
  ...
  directionsService.route(request, function (response, status) {
    if (status == google.maps.DirectionsStatus.OK) {
      ...
      const origin = { lat: data.passengerInfo[0].origin_latitude, lng: data.passengerInfo[0].origin_longitude };
      ...
      const destination = { lat: data.passengerInfo[0].destination_latitude, lng: data.passengerInfo[0].destination_longitude };
